...
class Inventario (tk.Frame):
    ...
    def widgets(self):
        ...
        titulo = tk.Label (self, text="INVENTARIO", bg = '#007790', font= 'sans 30 bold ', anchor='center') # Definicion de texto "ventas" y configuracion de tipo de letra, tamaño, negrilla habilitado y centrado  
        titulo.pack()
        ...
        labelframe = LabelFrame(frame2, text="Productos", font= "sans 22 bold", bg="#21c0d5")
        labelframe.place(x=20, y=30, width=400 , height=500)

        lblnombre = Label(labelframe, text= "Nombre: ", bg= "#21c0d5", font="sans 14 bold")
        lblnombre.place(x=10, y=20)
        self.nombre= ttk.Entry(labelframe, font="sans 14 bold")
        self.nombre.place(x=140, y=20, width=240, height=40)
         
        lblproveedor= Label(labelframe, text="Proveedor: ",bg= "#21c0d5", font="sans 14 bold")
        ...
        lblprecio = Label(labelframe, text="Precio: ",bg= "#21c0d5", font="sans 14 bold")
        ...
        lblcosto = Label(labelframe, text="Costo: ",bg= "#21c0d5", font="sans 14 bold")
        ...
        boton_agregar = tk.Button(labelframe, text="Ingresar", bg= "#007790", font="sans 12 bold", command=self.registrar)
        boton_agregar.place(x=80,y=340, width=240, height=40)

        boton_editar = tk.Button(labelframe, text="Editar", bg= "#007790", font="sans 12 bold", command=self.editar_producto)
        ...
        btn_actualizar = Button(frame2, text="Actualizar Inventario", font= "sans 14 bold", bg= "#007790", command=self.actualizar_inventario)
    ...
    def mostrar(self):
        ...
        for elem in result:
            try:
                precio_cop = "{:,.0f} COP".format(float(elem[3])) if elem [3] else ""
                costo_cop= "{:,.0f} COP".format(float(elem[4])) if elem [4] else ""
            except ValueError:
                precio_cop = elem [3]
                costo_cop = elem[4]
    ...
    def registrar(self):
        ...
        if self.validacion(nombre,prov,precio,costo,stock):
            try:
                ...
                messagebox.showwarning(title="Error", message=f"Error al registar el producto: {e}")
    ...
    def editar_producto(self):
        ...
        lbl_nombre = Label(ventana_editar, text="Nombre:", font= "sans 14 bold", bg="#21c0d5")
        ...
        lbl_proveedor = Label(ventana_editar, text="Proveedor:", font= "sans 14 bold", bg="#21c0d5")
        ...
        lbl_precio = Label(ventana_editar, text="Precio:", font= "sans 14 bold", bg="#21c0d5")
        ...
        lbl_costo = Label(ventana_editar, text="Costo:", font= "sans 14 bold", bg="#21c0d5")
        ...
        def guardar_cambios():
            ...
            try:
                ...
                messagebox.showwarning("Guardar cambios", "Ingrese valores numericos validos para costo y precio.")
                return
        ...
        btn_guardar = Button(ventana_editar, text="Guardar cambios", font="sans 14 bold",bg= "#007790", command=guardar_cambios)
